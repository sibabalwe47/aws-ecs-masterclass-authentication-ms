...
const signIn = async (req, res) => {
  try {
    ...
    const { data } = await axios.post(`http://${process.env.MIDDLEWARE_SERVICE_URL}/api/v1/sessions/store-session`, {
    ...
    Logger.writeLog({
      url: `${process.env.MIDDLEWARE_SERVICE_URL}/api/v1/session/store-session`,
